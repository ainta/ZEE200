//===-- ZKInstPrinter.cpp - Convert ZK MCInst to assembly syntax ----===//
//
...
//===----------------------------------------------------------------------===//
//
// This class prints an ZK MCInst to a .s file.
//
//===----------------------------------------------------------------------===//

#define DEBUG_TYPE "asm-printer"
#include "ZKInstPrinter.h"
...
// #include "ZKGenAsmWriter.inc"

void ZKInstPrinter::printRegName(raw_ostream &OS, unsigned RegNo) const {
  OS << StringRef(getRegisterName(RegNo)).lower();
}

void ZKInstPrinter::printInst(const MCInst *MI, raw_ostream &O,
...
static void printExpr(const MCExpr *Expr, raw_ostream &OS) {
  ...
  assert(Kind == MCSymbolRefExpr::VK_None ||
         Kind == MCSymbolRefExpr::VK_ZK_LO ||
         Kind == MCSymbolRefExpr::VK_ZK_HI);
...
void ZKInstPrinter::printCondCode(const MCInst *MI, unsigned OpNum,
                                   raw_ostream &O) {
...
void ZKInstPrinter::printAddrModeMemSrc(const MCInst *MI, unsigned OpNum,
                                         raw_ostream &O) {
...
void ZKInstPrinter::printOperand(const MCInst *MI, unsigned OpNo,
                                  raw_ostream &O) {
