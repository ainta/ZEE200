...
WORKDIR="$(mktemp -d /tmp/zee_gzip_decompress_prover_XXXXXX)"
echo "[zee gzip_decompress prover] WORKDIR=$WORKDIR"
...
./ZKMachine P 44444 $((19-2)) gzip.zk < gzip_decompress_input
