...
sweeps.
The Fibonacci program signals proof success only when the result matches
$\operatorname{fib}(20)=6765$ or $\operatorname{fib}(23)=28657$ for the
corresponding input; other indices do not signal proof success.
